                    ...
                    <td>
                      <table width="220" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                        <tbody>
                          ...
                          <tr>
                                @php
                                  $billing=App\Models\BillingDetail::where('order_id',$data)->first();
                                @endphp
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: right;">
                              <small>ORDER ID: </small> {{ $data }}<br />
                              <small>{{ App\Models\Order::where('order_id',$data)->first()->created_at->format('d-M-Y')}}</small>
                            </td>
                          </tr>
                        </tbody>
                      </table>
              ...
              <tr>
                <td>
                  ...
                  <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                    <tbody>
                    @php
                      $order=App\Models\Order::where('order_id',$data)->first();
                    @endphp
                      <tr>
                        ...
                        <td>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                  ...
                                  {{ $billing->name}}<br> {{ $billing->address}}
                                </td>
                              </tr>
                            </tbody>
                          </table>
                          ...
                          <table width="220" border="0" cellpadding="0" cellspacing="0" align="right" class="col">
                            <tbody>
                              ...
                              <tr>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                  Hand Cash{{-- Credit Card<br> Credit Card Type: Visa<br> Worldpay Transaction ID: <a href="#" style="color: #ff0000; text-decoration:underline;">4185939336</a><br> --}}
                        ...
                        <td>
                          <table width="220" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                            <tbody>
                              ...
                              <tr>
                              @php
                                $order=App\Models\ShippingDetail::where('order_id',$data)->first();
                              @endphp
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                  {{ $order->name }}<br> {{ $order->email }}<br> {{ $order->phone }}<br> {{ $order->company }}<br> {{ $order->address }}<br> 
                                </td>
                              </tr>
                            </tbody>
                          </table>
